# TursoDB Debugging Guide

> Domain-specific debugging for the Turso (tursodb) SQLite-compatible database engine.
> Apply the systematic-debugging methodology above, using these TursoDB-specific tools and patterns.
...
For WAL corruption and database integrity issues, see the corruption debug tools reference below.
