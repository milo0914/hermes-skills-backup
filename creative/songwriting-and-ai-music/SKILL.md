...
description: "Songwriting craft and Suno AI music prompts. Umbrella skill absorbing general songwriting mentorship (singer) and Suno lyrics formatting (suno)."
tags: ["songwriting", "music", "suno", "parody", "lyrics", "creative", "ai-music"]
triggers:
 - writing a song
 - song lyrics
 - music prompt
...
This umbrella skill absorbed the following narrower skills during consolidation (2026-05-09):

### singer (archived)
The `singer` skill provided general songwriting mentorship including:
- Songwriting prompts and idea generation
- Rhyme, synonym, and phrase suggestions for lyric development
- Constructive feedback on lyrics and melodies
- Tips on song structure (verse, chorus, bridge)
- Melody and chord progression assistance
- Analysis of famous songs for technique illustration

All general songwriting guidance has been absorbed into Sections 1-4 of this umbrella skill.

### suno (archived)
The `suno` skill focused exclusively on Suno AI lyrics formatting:
- Suno markup syntax ([Intro], [Verse], [Chorus], etc.)
- Sound effect tags ([Laughter], [Whisper], [Censored beep])
- Music style descriptors (max 120 characters)
- Required template format with [END] marker
- Example lyrics in "City Vibes" format

All Suno-specific formatting guidance has been absorbed into Sections 6-7 of this umbrella skill. The detailed Suno template example has been preserved in `templates/suno-lyrics-template.md` for quick reference.
