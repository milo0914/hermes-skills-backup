# Felo AI Real-Time Search

> Felo AI provides real-time web search via API. Use when research requires current/live information.
...
- **Patent/Technical research:** When browser automation tools are unavailable, can search for patent-related news, company announcements, or technical literature (but NOT direct patent database access)
