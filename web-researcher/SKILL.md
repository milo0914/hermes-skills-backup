...
- `references/arxiv-search.md` — Search, fetch, and analyze academic papers from arXiv.org
- `references/felo-search.md` — Felo AI real-time web search for current/live information (multi-language, curl-based)

## Sub-Tools

| Tool | When to Use | Reference |
|------|-------------|-----------|
| **Felo AI Search** | Current events, news, real-time data, location queries, shopping | `references/felo-search.md` |
| **arXiv Search** | Academic papers, literature reviews, research summaries | `references/arxiv-search.md` |
| **Scrapling** | Web scraping, anti-bot bypass, site crawling | See `scrapling` skill |
| **Patent Search** | Patent databases, prior art analysis | `references/patent-search-strategy.md` |
